...
class Player: 
    def __init__(self):
        self.camera = Camera(Ray(Vector2(0,0),0),1.5)
        ...
        self.controller.addBind(K_d,whileDown= lambda dt: self.turn(0.5* dt) )
        self.controller.addBind(K_a,whileDown= lambda dt: self.turn(0.5* -dt))
